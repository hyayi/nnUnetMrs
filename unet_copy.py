...
class PlainConvClsUNet(nn.Module):
    def __init__(self,
        ...
        self.headers = nn.Sequential(nn.Linear(features_per_stage[-1]*5*7*7, 4092), nn.ELU(),nn.Dropout(0.5), nn.Linear(4092, 1000), nn.ELU(), nn.Linear(1000, 29), nn.ELU(), nn.Linear(29, num_classes))
    def forward(self, x):
